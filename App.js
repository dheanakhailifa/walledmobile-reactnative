...
export default function App() {
  return (
    ...
    <View style={{flexDirection: 'row', width : 381, height:68, marginTop:60,display: 'flex', backgroundColor:'#FFF'}}>
    ...
    <View style={{width:337, height:43, marginTop:40, backgroundColor: 'teal',borderRadius:30,display:'flex', marginLeft:20, flexDirection: 'row', elevation:2, justifyContent:'space-between', alignItems:'center', paddingHorizontal:20, marginBottom:5}}>
